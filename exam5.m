...
- (void)viewDidLoad {
	...
	NSString *path2 = [[NSBundle mainBundle] pathForResource:@"젖소" ofType:@"mp3"];
	NSURL *url2 = [NSURL fileURLWithPath:path2];
	sound2 = [[AVAudioPlayer alloc] initWithContentsOfURL:url2 error:nil];
	
	NSString *path3 = [[NSBundle mainBundle] pathForResource:@"돼지1" ofType:@"m4a"];
...
- (IBAction)real:(id)sender{
	...
	//exam5 *nextexam = [[exam5 alloc] init];
